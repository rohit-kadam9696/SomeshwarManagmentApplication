...
part of 'crushing_report.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

CrushingReport _$CrushingReportFromJson(Map<String, dynamic> json) =>
    CrushingReport(
      todayCrushing: (json['todayCrushing'] as num?)?.toDouble(),
      uptoTodayCrushing: (json['uptoTodayCrushing'] as num?)?.toDouble(),
    )
...
Map<String, dynamic> _$CrushingReportToJson(CrushingReport instance) =>
    <String, dynamic>{
      ...
      'todayCrushing': instance.todayCrushing,
      'uptoTodayCrushing': instance.uptoTodayCrushing,
    };
